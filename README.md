...
- Use our modified caffe: [caffe_rtpose](https://github.com/CMU-Perceptual-Computing-Lab/caffe_demo/). Follow the instruction on that repo. In May 2017, we released a updated library [openPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose)
